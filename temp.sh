...
su -s /bin/bash pi -c "git add ."
echo COMMITTING... >> /home/pi/Documents/Website_Test/ETL.log 2>&1
su -s /bin/bash pi -c "git config --global user.name " >> /home/pi/Documents/Website_Test/ETL.log 2>&1
su -s /bin/bash pi -c "git commit -m 'auto_commit_$DATE'" >> /home/pi/Documents/Website_Test/ETL.log 2>&1
